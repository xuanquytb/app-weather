            ...
            <div className="flex flex-col mt-8 bg-[#4b99c9] rounded-lg ml-3 mr-1 h-[250px] laptop:h-[240px]">
                <div className="flex ">
                    ...
                    <div className="w-[244px] h-11 flex items-end flex-row-reverse pr-3">
                        <div className="w-[33px] h-[33px] laptop:w-[40px] laptop:h-[40px] rounded-xl flex items-center justify-center">
                        ...
                        <div className="w-[33px] h-[33px] laptop:w-[40px] laptop:h-[40px] rounded-lg flex items-center justify-center bg-[#f7812d]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                <path fill="none" d="M0 0h24v24H0z" />
                        ...
                        <div className="w-[33px] h-[33px] laptop:w-[40px] laptop:h-[40px] rounded-lg flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                <path fill="none" d="M0 0h24v24H0z" />
