            ...
            <div className="px-[20px] py-[20px] h-[200px] w-full ">
                <div className="flex">
                    ...
                    <div className="ml-3">
                        ...
                        <p className="font-medium text-gray-700">{props.nameCity}</p>
                        <p className="font-medium text-gray-700">Độ ẩm: {humidity} %</p>
                    </div>
                </div>
                <div className="w-4 h-[6px] bg-white rounded-lg text-[#111111] text-[14px] font-semibold mt-5 ml-[8px] mb-0 mr-0 text-center"></div>

                <div className="w-full h-[75px] flex justify-between mt-[36px]">
                    <div className="text-white rounded-lg text-[16px] flex items-center justify-center flex-col w-[108px] h-[75px] bg-[#19283f]">
                        <p>Nhiệt độ</p>
